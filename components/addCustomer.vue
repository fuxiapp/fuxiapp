			...
			<view class="add-con">
				<view class="add-base-info">
					...
					<view class="item">
						...
						<view class="add-input"><input  id="no" placeholder="编码" value="12344545" /></view>
					</view>
					<view class="item">
				...
				<view class="add-base-info">
					...
					<view class="item" @click="selCity(1)">
						...
						<view class="add-input"><input placeholder="省份" /></view>
					</view>
					<view class="item">
						<view class="add-title">城市</view>
						<view class="add-input"><input placeholder="城市" /></view>
					</view>
					<view class="item">
						<view class="add-title">区县</view>
						<view class="add-input"><input placeholder="区县" /></view>
					</view>
					<view class="item">
		...
		<view  v-if="isShowCity">
			...
			<view class="radio-con">
				<view class="radio-info-con">
					<view class="item" v-for="(item, index) in cityS" :key="index" @click="okCityValue(name, index)">
						{{item.name}}
					</view>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			okCityValue (name, index) {
				let val = {name: name, index: index};
				this.$emit('okCityValue',  val);
			},
		}
