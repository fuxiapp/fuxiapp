...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var API = {
  get: function get(url, token) {var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var method = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'GET'; // get请求
      ...
      uni.request({
        ...
        success: function success(res) {
          if (res.statusCode !== 200) {
            uni.showToast({
              title: "".concat(res.statusCode, "\u9519\u8BEF"),
              icon: 'none' });
  ...
  post: function post(url, token) {var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}; // post请求
    return new Promise(function (resolve, reject) {
      // 获取网络类型
      url = "";
      uni.request({
  ...
  //图片上传
  upload: function upload(_success, fail) {
    var url = '';
    // 获取网络类型
    url = "";
    uni.chooseImage({
  ...
  if (!!this.events[type]) {
    this.events[type].forEach(function (listener) {
      try {
        ...
        console.error(e, " at components\\wxcharts.js:2371");
      }
    });
  }
};
...
_vue.default.prototype.$URL = 'http://';
