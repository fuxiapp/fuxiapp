...
//
//
var _self;var canvaColumn = null;var canvaLineA = null;var canvaLineB = null;var canvaArea = null;var canvaGauge = null;var _default = { data: function data() {return { cWidth: '', cHeight: '', pixelRatio: 1, serverData: '', noInfo: [{ icon: 'iconsales-order', url: '../../sale/salesSelCustomer/salesSelCustomer', title: '销售订单', bac: '#427CAC', routeType: 2, type: 0 }, { icon: 'iconfahuodan', url: '../../sale/salesSelCustomer/salesSelCustomer', title: '销售发货单', bac: '#F65341', routeType: 2, type: 1 }, { icon: 'icontuihuodan', url: '../../sale/selStore/selStore', title: '销售退货单', bac: '#FD943E', routeType: 2, type: 2 }, { icon: 'iconicon-caigoudd', url: '../../purchaseOrder/purchaseOrder', title: '采购订单', bac: '#427CAC', routeType: 2, type: 3 }, { icon: 'iconshouhuodan', url: '../../sale/salesPurchase/salesPurchase', title: '采购收货单', bac: '#12BC7F', routeType: 2, type: 4 }, { icon: 'icontuihuodan', url: '../../sale/salesPurchase/salesPurchase', title: '采购退货单', bac: '#BC7AF1', routeType: 2, type: 5 }, {
  ...
  methods: {
    toPath: function toPath(url, routeType, type) {// tab页面跳转
      var router = "".concat(url, "?type=").concat(type);
      if (routeType === 1) {
        this.$API.tab(router);
      } else {
        this.$API.to(router);
    ...
    getServerData: function getServerData() {
      uni.request({
        ...
        success: function success(res) {
          console.log(res.data.data, " at pages\\tab\\main\\main.vue:310");
        ...
        fail: function fail() {
          console.log("数据获取失败！", " at pages\\tab\\main\\main.vue:330");
        } });
