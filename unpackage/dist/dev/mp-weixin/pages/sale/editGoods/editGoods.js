...
var _default =
{
  ...
  methods: {
    toPath: function toPath() {
      if (this.moduleType === 7) {
        this.$API.to("../../sale/addGoodsConfig/addGoodsConfig?id=".concat(this.id, "&type=").concat(this.moduleType));
      } else {
        this.$API.to("../../sale/saleComfig/saleComfig?id=".concat(this.id, "&type=").concat(this.moduleType));
      }
    },
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/sale/editGoods/editGoods.js.map